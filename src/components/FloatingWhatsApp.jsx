export default function FloatingWhatsApp() {
  return (
    <a 
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center gap-2 bg-[#25D366] text-white p-3.5 sm:px-5 sm:py-3 rounded-full shadow-[0_8px_24px_rgba(37,211,102,0.3)] hover:bg-[#20ba5a] hover:scale-[1.03] transition-all duration-300 font-body font-semibold text-[13.5px] decoration-none"
