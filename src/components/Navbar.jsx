  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-white/95 backdrop-blur-[16px] border-b border-black/5 shadow-[0_4px_30px_rgba(0,0,0,0.05)]' 
          : 'bg-white/80 backdrop-blur-[12px] border-b border-transparent'
      }`}
      role="navigation"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <ul className="flex items-center gap-8 font-body text-[13px] font-medium text-[#475569] list-none">
            <li>
              <a
                href="#home"
                onClick={(e) => handleScrollTo(e, 'home')}
                className="hover:text-[#00B4A6] transition-colors relative py-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[2px] after:bg-[#00B4A6] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
              >
                Home
              </a>
            </li>
        ...
        <div className="hidden md:block">
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] text-white font-body font-semibold text-[13px] px-6 py-2.5 rounded-full hover:bg-[#20BE5A] transition-all hover:-translate-y-0.5 shadow-[0_4px_14px_rgba(37,211,102,0.25)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.35)]"
          >
      ...
      >
        <div className="flex flex-col px-8 gap-4">
          ...
          <a href="#test-finder" className="font-body font-medium text-base text-[#475569] hover:text-[#00B4A6] py-2 border-b border-black/5" onClick={(e) => handleScrollTo(e, 'test-finder')}>Test Finder</a>
          ...
          <a
            href="https://wa.me/918777578862?text=Hi%2C%20I%20want%20to%20book%20a%20test%20at%20Forthlines%20Diagnostics"
            className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-body font-bold text-sm py-3 rounded-full mt-2 hover:bg-[#20BE5A] transition-colors"
